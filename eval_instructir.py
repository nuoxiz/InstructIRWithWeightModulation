...
if __name__=="__main__":
    ...
    model.load_state_dict(torch.load(MODEL_NAME, map_location="cuda:0"), strict=True)
    ...
    if cfg.model.use_text:
        ...
        lm_head.load_state_dict(torch.load(LM_MODEL, map_location="cuda:0"), strict=True)
