...
class NAFBlock(nn.Module):
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0., modify_conv_weights=False):
        ...
        # # adaptation for modifying the conv2d weights
        # if modify_conv_weights:
        #     self.modify_conv_weights = modify_conv_weights
        #     self.weights_modifier_1 = CBINorm_Conv2d(dw_channel, c)
